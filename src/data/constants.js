...
export const experiences = [
  {
    ...
    desc: "Underwent rigorous training sessions on JD Edwards (JDE) EnterpriseOne, focusing on foundational concepts, ERP modules, and enterprise application functionalities. Gained hands-on experience in understanding and supporting JDE processes, including addressing real-time enterprise resource planning challenges and system configurations.",
    skills: [
      "JDE",
      "Windows Powershell",
      "Batch Programming",
...
export const projects = [
  ...
  },
  {
    ...
    image:
      "https://drive.google.com/file/d/1yGp5B4ygIpGgCTpGUYphA1PUe44zmoOu/view?usp=sharing",
